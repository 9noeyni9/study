...
/*
 * 버튼(Button)
 *  : 버튼은 가장 많이 사용되는 GUI 컴포넌트이고, 주로 사용자의
 *    입력을 받을 떄 사용합니다. 사용자가 어떤 결정을 내릴 떄 
 *    사용하는 컴포넌트입니다.
 *    
 *      생성자
 *      
 ...
 *      public void  getLabel(String Label)      : 버튼위에 문자열 지정
 *      public void  addActionListner(ActionListner al)  : 버튼에서 발생한 액션이벤트를 처리할 수 있도록 등록
 *      
 *      public String getActionCommand()            : 버튼에서 이벤트가 발생하면 Command(명령) 이름을 받아 옵니다.
 *      public void setActionCommand(String cmd)    : 버튼에 커맨드 이름을 설정
 *      */
