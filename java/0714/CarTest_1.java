...
class Car
{
	String color;  // 멤버변수 (필드,전역변수)	
	String gearType;
	int door;
	String direction;
	
	public Car() { //default 생성자 (생성자가 없으면 자동으로 만들어줘,,?)
	...
	public String toString() {
		return "color : " + color + " , gearType : " + gearType + " door : " + door +"direction : "+ direction  ;  //투스트링은 오버라이딩된 것..?
...
public class CarTest_1 {
	...
	public static void main(String[] args) {
		...
		Car car1  = new Car();  // 왼항은 스택에 들어가고 뉴카는 히프에 저장
