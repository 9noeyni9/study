...
class BB_3 extends AA_3{
	...
	void display() { //오버라이딩 >>상속관계에서 메소드가 똑같음!!
...
public class SuperTest_3 {  //출력은 여기부터!
	...
	public static void main(String[] args) {
		...
		AA_3 obj_3 = new BB_3();// 객체의 형변환시 (상속관계에 있는 경우에) 멤버 변수는 쉐도잉 되고 멤버 메소드는 오버라이딩 된다고 함(인터페이스에서 많이 씀 외워두기)
