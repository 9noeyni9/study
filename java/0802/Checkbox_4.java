...
public class Checkbox_4 {
	public static void main(String[] args) {
		...
		Label q1 = new Label("1. 당신의 관심 분야는? (여러 개 선택 가능)");
		...
		Checkbox movie2 = new Checkbox("두 달에 한 번 갑니다",group1,false );
		Checkbox movie3 = new Checkbox("안 갑니다",group1, false);
		...
		Label q3 = new Label("3. 하루에 얼마나 컴퓨터를 사용 하십니까?");
