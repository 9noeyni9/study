...
class ATM_2
{
	...
	public ATM_2(int total) {
		...
		void deposit(int amount, String name) { //synchronized는 동시접근을 막는 키워드야 synchronized에 없이 실행 했다면 금액들이 맞지 않아
		total += amount;
...
class ATM_USER_2 extends Thread //ATM 사용자(는 스레드를 통해서 만들 것)
{
