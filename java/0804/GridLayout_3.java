...
public class GridLayout_3 {
	public static void main(String[] args) {
		...
		Frame ff = new Frame();
		ff.setLayout(new GridLayout(17,2)); //행과 열 잘 생각해
		...
		Panel p15 = new Panel();   p15.setBackground(new Color(223,223,255));
		Panel p16 = new Panel();   p16.setBackground(new Color(216,246,255));
		Panel p17 = new Panel();   p17.setBackground(new Color(236,236,255));
		...
		ff.add(new Label("Color(223,223,255)"));   ff.add(p15);
		ff.add(new Label("Color(216,246,255)"));   ff.add(p16);
		ff.add(new Label("Color(236,236,255)"));   ff.add(p17);
